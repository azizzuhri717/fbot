...
try:
    ...
    os.system('pip install ipranges')
...
def hardwarecheck():
   ...
   # try:
    if hwid not in hwlists: 
        ...
        vinfo( "{b}!", "HWID : " + hwid )
        vinfo( "{r}x", "Your hwid is not registered in violent system {y}( Auto Closed In 60 Seconds )" )
      ...
      #  if sites:
        ...
        class ZoomEye(object):
            ...
            def search(self):
                ...
                while True:
                    try:
                        ...
                        # è‹¥æœç´¢è¯·æ±‚è¶…è¿‡ API å…è®¸çš„æœ€å¤§æ¡ç›®é™åˆ¶ æˆ–è€… å…¨éƒ¨æœç´¢ç»“æŸï¼Œåˆ™ç»ˆæ­¢è¯·æ±‚
                        if str(e) == 'matches':
            ...
            def save_result(self):
                # ä»¥å½“å‰è¿è¡Œè„šæœ¬çš„æ—¶é—´åˆ›å»ºæ–‡ä»¶,è¿™æ ·å°±å¯ä»¥ä¿è¯è„šæœ¬è¿è¡Œæ—¶åˆ›å»ºçš„æ–‡ä»¶ä¸ä¼šé‡å
